...
def main(date) :
  try :
    ...
    file_list_in_bronze = s3_client.list_objects_v2(Bucket=bronze_bucket, Prefix='product/input/'+bronze_file_name+'/', Delimiter='/')
    ...
    if validation_flag :
      ...
      if silver_product_df.count() == 0 :
        ...
        file_list_in_silver = s3_client.list_objects_v2(Bucket=silver_bucket, Prefix='product/', Delimiter='/')
        file_list_in_silver_temp = s3_client.list_objects_v2(Bucket=silver_bucket, Prefix='product/temp/', Delimiter='/')
